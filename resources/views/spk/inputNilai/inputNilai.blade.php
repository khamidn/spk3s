...
<form id="form_advanced_validation" action="{{route('inputNilai.simpan')}} " method="POST" class="form-horizontal">
{{csrf_field()}}
		...
		<div class="card">
			...
			<div class="body">
				...
				<ul class="nav nav-tabs tab-nav-right">
					<li role="presentation" class="active"><a href="#nilai-awal" data-toggle="tab" >NILAI SISWA</a></li>
					<li role="presentation" class="hidden"><a href="#nilai-dikonversi" data-toggle="tab">NILAI DIKONVERSI</a></li> 
				</ul>
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane fade in active" id="nilai-awal">
								...
								<tbody>
									...
									if(count($siswa)){
										...
										for($i=1; $i<=$jumlah; $i++){
											...
											if($noSub1==5){
											echo'<td>';
													echo'<select name="kolom-'.$newname.'" id="na-k'.$noUtama1.'b'.$noSub1.'" data-target="k'.$noSub1.'b'.$noUtama1.'" data-kolom="'.$noSub1.'" class="form-control inputnumber kolomm'.$noSub1.'" title="kolomm'.$noSub1.'">';
														$c='A';
														$chars=array($c);
														if($nilai==0){
											...
											elseif($noSub1==6){
												...
												echo '<td><div class="form-group"><div class="form-line"><input type="number" name="kolom-'.$newname.'" id="na-k'.$noUtama1.'b'.$noSub1.'"  class="form-control inputnumber kolom'.$noSub1.'" value="'.$nilai.'" /></div></div></td>';	
											}
										}
										echo '</tr>';
										}
						...
						<div class="row">
							<div class="col-lg-3">
									<button type="submit" id="simpanNilai" name="submit" class="btn btn-success waves-effect">Simpan Nilai</button>
									<button type="button" id="hitungAhpTopsis" class="btn btn-primary waves-effect"></button>
								</div>
							</div>
